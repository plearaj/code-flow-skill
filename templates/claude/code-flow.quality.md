...
`files` array — a file that cannot be read at all, whatever the reason, counts as
changed for this comparison. Count how many mapped files no longer match; that
count goes in the banner in step 6.
