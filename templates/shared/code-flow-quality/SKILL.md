...
that tripped once. A function reached by several flows has a depth in each: take
the deepest and name that flow in the rationale. Never emit one finding per
metric or one per flow.
